...
export default function WeChatLoginButton() {
  const handleWeChatLogin = () => {
    ...
    const redirectUri = encodeURIComponent(
      `${window.location.origin}/api/auth/callback/wechat`
    );
  ...
  return (
    <button
      ...
      className="flex w-full items-center justify-center gap-3 rounded-full border-2 border-black bg-white py-3 text-sm font-semibold text-black transition-all hover:bg-black hover:text-white"
    >
